<footer>
  <div class="footer-inner">
    ...
    <div class="footer-col footer-col--brand">
      ...
      <p class="footer-address">
        <strong style="color: var(--bianco); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.08em;">Sede Legale</strong><br>
        Piazza Immacolata 16<br>
        70024 Gravina in Puglia (BA)<br>
        <br>
        <strong style="color: var(--bianco); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.08em;">Sede Espositiva</strong><br>
        S.P. 231 (ex SS. 98) Km 42100<br>
        C.da Capitolo · Trani (BT)<br>
      </p>
      <a href="https://maps.app.goo.gl/tk7LzWXqG5YHveWn7" target="_blank" rel="noopener" class="footer-maps">
    ...
    <div class="footer-col footer-col--contacts">
      <a href="tel:+393356956131" class="footer-contact-row">
      ...
      <a href="tel:+393931911704" class="footer-contact-row">
        <svg viewBox="0 0 24 24"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/></svg>
        +39 393 1911704
      </a>
      <a href="tel:+390883501963" class="footer-contact-row">
        <svg viewBox="0 0 24 24"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/></svg>
        +39 0883 501963
      </a>
      <a href="mailto:concarimorchi@gmail.com" class="footer-contact-row">
        <svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
        concarimorchi@gmail.com
      </a>
      <a href="https://wa.me/393931911704" target="_blank" rel="noopener" class="footer-whatsapp">
  ...
  <div class="footer-bottom">
    <p>© <?php echo date('Y'); ?> Conca Rimorchi · P.IVA 05233440725 · Tutti i diritti riservati · <a href="<?php echo home_url('/privacy-policy'); ?>" style="color: var(--testo-sec); text-decoration: none;">Privacy Policy</a> · <a href="<?php echo home_url('/cookie-policy'); ?>" style="color: var(--testo-sec); text-decoration: none;">Cookie Policy</a></p>
  </div>
