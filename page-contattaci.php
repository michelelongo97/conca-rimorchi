      ...
      <div class="contatti-grid">
        ...
        <div class="contatti-info">
          ...
          <div class="info-block">
            ...
            <div class="info-value" style="font-size: 1.1rem; color: var(--blu);">Gravina in Puglia (BA)</div>
            <p class="info-note">Piazza Immacolata, 16<br>70024 Gravina in Puglia (BA)</p>
          </div>

          <div class="info-block">
            <div class="info-label">Sede Espositiva</div>
            <div class="info-value" style="font-size: 1.1rem; color: var(--blu);">Andria – Trani (BT)</div>
            <p class="info-note">S.P. 231 (ex SS. 98) Km 42100<br>C.da Capitolo · Trani (BT)</p>
