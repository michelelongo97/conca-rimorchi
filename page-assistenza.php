...
<section class="page-section section-light" style="border-top: 1px solid #d0d8ee;">
  ...
  <section class="page-section" style="background: var(--nero); border-top: 1px solid var(--bordo);">
    <div class="section-inner">
      ...
      <h2 class="section-title" style="margin-bottom: 16px;">I nostri servizi<br>di assistenza</h2>
      <p class="section-subtitle">Dalla manutenzione ordinaria agli interventi strutturali — siamo attrezzati per ogni esigenza.</p>
      <div class="assistenza-grid">
        ...
        <div class="assistenza-card fade-in">
          ...
          <p class="assistenza-desc">Verifiche di sicurezza periodiche per mantenere i mezzi conformi alle normative vigenti. Controlliamo freni, luci, pneumatici, struttura e tutti i componenti critici per garantire la continuità operativa e la sicurezza su strada.</p>
        </div>

        <div class="assistenza-card fade-in fade-delay-1">
          <div class="assistenza-num">02</div>
          <div class="assistenza-name">Manutenzione</div>
          <p class="assistenza-desc">Ordinaria e straordinaria. Interveniamo tempestivamente per ridurre i fermi operativi e mantenere i mezzi sempre efficienti su strada. Programmiamo gli interventi in base alle esigenze operative del cliente per minimizzare i disagi.</p>
        </div>
        ...
        <div class="assistenza-card fade-in fade-delay-2">
          ...
          <p class="assistenza-desc">Su componenti meccanici e strutturali. Diagnosi precisa e intervento rapido per ogni tipo di problema tecnico. Utilizziamo ricambi originali e compatibili selezionati per garantire la massima affidabilità nel tempo.</p>
        </div>
        ...
        <div class="assistenza-card fade-in fade-delay-1">
          ...
          <p class="assistenza-desc">Il rapporto non si conclude con la consegna. Siamo disponibili per ogni esigenza, informazione tecnica e aggiornamento nel tempo. Accompagniamo il cliente nella gestione del mezzo assicurando tranquillità operativa.</p>
        </div>
...
<section class="page-section section-light" style="border-top: 1px solid #d0d8ee;">
  ...
  <section class="page-section" style="background: var(--blu-scuro); border-top: 1px solid var(--bordo); text-align: center;">
    <div class="section-inner">
      <div class="section-tag" style="justify-content: center;">Contattaci</div>
      <h2 class="section-title" style="text-align: center; margin-bottom: 20px;">Hai bisogno<br>di assistenza?</h2>
      <p style="color: var(--testo-sec); max-width: 480px; margin: 0 auto 40px; line-height: 1.7;">Contattaci subito — il nostro team è pronto ad intervenire nel minor tempo possibile.</p>
      <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
        <a href="<?php echo home_url('/contattaci'); ?>" class="btn-primary">
          Richiedi assistenza
          <svg viewBox="0 0 16 16" fill="white" width="14" height="14"><path d="M8 0l8 8-8 8-1.4-1.4L12.2 9H0V7h12.2L6.6 1.4z"/></svg>
        </a>
        <a href="tel:+393356956131" class="btn-secondary">
          Chiama ora
        </a>
      </div>
    </div>
