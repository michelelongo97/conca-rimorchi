...
<main id="archive-rimorchi">
  ...
  <section class="page-hero">
    <div class="page-hero-inner">
      ...
      <h1 class="page-hero-title">Rimorchi<br><span style="color: var(--verde);">nuovi</span></h1>
      <p class="page-hero-desc">Semirimorchi nuovi per ogni esigenza del <strong>trasporto professionale</strong>. Conformi alle normative vigenti.</p>
    </div>
  </section>
    ...
    <div class="section-inner">
        ...
        <div class="rimorchi-grid">
          ...
          <a href="<?php the_permalink(); ?>" class="rimorchio-card">
            <div class="rimorchio-card-img">
              ...
              <?php endif; ?>
              <div class="rimorchio-badge rimorchio-badge--condizione nuovo">Nuovo</div>
      ...
      <?php else : ?>
        <div class="rimorchi-empty">
          <p>Nessun rimorchio nuovo disponibile al momento.</p>
